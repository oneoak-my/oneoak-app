...
const SIZE_CLASSES: Record<ButtonSize, string> = {
  sm: 'px-3 py-2.5 text-xs rounded-lg',
...
export default function Button({
  ...
  return (
    <button
      className={cn(
        'inline-flex items-center justify-center gap-2 transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 touch-manipulation',
